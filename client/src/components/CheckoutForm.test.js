...
test("form shows success message on submit with form details", () => {
    ...
    fireEvent.change(firstNameInput, { target: { name: 'firstName', value: "Reza" } });
    fireEvent.change(lastNameInput, { target: { name: 'lastName', value: "Rahman" } });
    fireEvent.change(addressInput, { target: { name: 'address', value: "418 Grant Ave" } });
    fireEvent.change(cityInput, { target: { name: 'city', value: "Brooklyn" } });
    fireEvent.change(stateInput, { target: { name: 'state', value: 'NY' } });
    fireEvent.change(zipInput, { target: { name: 'zip', value: '11208' } });
